  ...
  <b-row class="justify-content-center">
    <b-col col sm="4">
      <b-card no-body>
        ...
        <b-card-body>
          <form name="vue-login" autocomplete="off">
            <b-card-text>
              <label>Email</label>
            ...
            <b-card-text>
              ...
              <b-input class="form-control" type="password" id="password" placeholder="Clave" v-model="password" />
            </b-card-text>
          </form>
          <b-button variant="primary" class="mt-2" @click="login">
            Login
          </b-button>
        </b-card-body>
        <b-card-footer>
